...
public class HelloController implements Initializable {
    ...
    public String ipVar="25.48.172.153";
    public TextField ip;
...
//RELOGIO FIM
    ...
    public void criarCliente() throws IOException {
        ...
        clienteCheck=true;
        try{
            client = new Client(new Socket(ipVar,2222));
...
//Fim de previsualização de colocação de barcos
    ...
    public void atacar(int posx,int posy) throws IOException {
        paneEni[posx][posy].setStyle("-fx-background-color: rgba(120,210,238,0.7)");
    ...
    public void getIp() throws IOException {
        ...
        try{
            client = new Client(new Socket(ipVar,2222));
            connect.setStyle("-fx-background-color: #227919");
            System.out.println("Conectado ao server");
        }catch (IOException e){
            connect.setStyle("-fx-background-color: #c41e1e");
            System.out.println("Erro a conectar ao servidor");
            e.printStackTrace();
        }
